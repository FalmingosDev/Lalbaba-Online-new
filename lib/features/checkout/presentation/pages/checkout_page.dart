...
//               continueButtonText: 'Continue to Shippingg',
...
///
/// Simulates fetching whatever the checkout page needs before it can render
/// the real content (cart summary, saved address, etc).
///
final checkoutInitProvider = FutureProvider.autoDispose<bool>((ref) async {
...
class _CheckoutPageState extends ConsumerState<CheckoutPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final AsyncValue<bool> checkoutInit =
        ref.watch(checkoutInitProvider);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    checkoutInit.when(
                      ...
                      /// -------------------------------------------------------
                      data: (_) {
                        return const CheckoutProductWidget();
                      },
                      ...
                      /// -------------------------------------------------------
                      loading: () {
                        return const CheckoutProductShimmer();
                      },
      ...
      MaterialPageRoute(
        builder: (
          ...
          return DeliveryWidget(
            ...
            /// ================================================================
            ///
            /// Payment page তৈরি হলে এখানে navigation বসবে।
            ///
            onContinueToPayment: () {
              /// Example:
              ///
